...
io.on('connection', (socket) => {
  ...
  socket.on('connect-finale-master', (data) => handleConnection(socket, JSON.stringify({ type: 'connect-finale-master' }), data));
  ...
  socket.on('reset-finale-quiz', (data) => handleFinaleResetQuiz(data,socket, io));
